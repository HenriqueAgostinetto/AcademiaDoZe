...
public class Matricula : Entity
{
    ...
    public Matricula(int id, Aluno aluno, MatriculaPlano plano, DateOnly dataInicio, DateOnly dataFinal, string objetivo, MatriculaRestricoes restricoes, string observacoesRestricoes, Arquivo laudoMedico)
        : base(id)
    {
        Aluno = aluno;
        Plano = plano;
